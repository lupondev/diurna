...
const templates: Record<string, Template[]> = {
  football: [
    ...
    { id: 'fixtures', icon: '📅', name: 'Fixtures', desc: 'Upcoming matches' },
    { id: 'match-stats', icon: '📊', name: 'Match Stats', desc: 'Full statistics' },
    { id: 'lineups', icon: '👥', name: 'Lineups', desc: 'Team formations' },
  ],
  polls: [
