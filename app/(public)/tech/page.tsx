...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Tech — ${siteName}`,
    description: 'Najnovije tehnološke vijesti.',
    alternates: { canonical: canonicalUrl('/tech') },
  }
}
  ...
  return (
    <main className="sba-cat">
      ...
      <div className="sba-cat-header">
        <h1 className="sba-cat-title">Tech</h1>
        <p className="sba-cat-desc">Najnovije tehnološke vijesti</p>
      </div>
          ...
          {featured && (
            <Link href={featured.href} className="sba-cat-featured">
              ...
              <div className="sba-cat-featured-content">
                <span className="sba-cat-badge">Tech</span>
