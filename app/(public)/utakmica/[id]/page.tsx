  ...
  useEffect(() => {
    ...
    if (tab === 1 && statistics === null) {
      ...
      fetch(`/api/match/${id}?section=stats`)
        .then(r => r.json())
        .then((d) => setStatistics((d as any).statistics ?? []))
        .catch(() => setStatistics([]))
    ...
    if (tab === 2 && lineups === null) {
      ...
      fetch(`/api/match/${id}?section=lineups`)
        .then(r => r.json())
        .then((d) => setLineups((d as any).lineups ?? { home: null, away: null }))
            ...
            <div className="mc-main">
              <div className="mc-hdr">
                <div className="mc-comp">
                  ...
                  {status === 'live' && <span className="mc-live"><span className="mc-live-dot" />ŽIVO · {elapsed}&apos;</span>}
