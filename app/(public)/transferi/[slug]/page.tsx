...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  return buildArticleMetadata(params.slug, 'transferi')
}

export default async function TransferiArticlePage({ params }: Props) {
  const data = await fetchArticle(params.slug, 'transferi')
  if (!data) {
