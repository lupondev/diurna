...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Bosna i Hercegovina — ${siteName}`,
    description: 'Vijesti iz Bosne i Hercegovine.',
    alternates: { canonical: canonicalUrl('/bih') },
  }
}
  ...
  return (
    <main className="sba-cat">
      ...
      <div className="sba-cat-header">
        <h1 className="sba-cat-title">Bosna i Hercegovina</h1>
        <p className="sba-cat-desc">Vijesti iz Bosne i Hercegovine</p>
      </div>
          ...
          {featured && (
            <Link href={featured.href} className="sba-cat-featured">
              ...
              <div className="sba-cat-featured-content">
                <span className="sba-cat-badge">BiH</span>
