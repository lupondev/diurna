        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="space-y-2.5">
                ...
                <Link href="/site/terms" className="block text-[13px] transition-colors" style={{ color: '#6B6B6B' }}>Terms</Link>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between pt-8 gap-4" style={{ borderTop: '1px solid rgba(0,0,0,0.06)' }}>
            ...
            <div className="flex gap-2.5">
              <a href="https://lupon.media" target="_blank" rel="noopener noreferrer" aria-label="Lupon Media" className="w-8 h-8 rounded-lg flex items-center justify-center transition-all" style={{ background: 'rgba(0,0,0,0.04)', border: '1px solid rgba(0,0,0,0.06)' }}>
                <span className="text-[13px] font-bold" style={{ color: '#6B6B6B' }}>L</span>
              </a>
            </div>
          </div>
        </div>
